...
class Cylindre extends Objet3D {
	...
	protected void genereMaillage() {
		...
		add(new Sommet(1.000000 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.000000 * rayon + centreBas.getZ()));
		add(new Sommet(0.951056 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.309016 * rayon + centreBas.getZ()));
		add(new Sommet(0.809016 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.587786 * rayon + centreBas.getZ()));
		add(new Sommet(0.587786 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.809016 * rayon + centreBas.getZ()));
		add(new Sommet(0.309016 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.951056 * rayon + centreBas.getZ()));

		add(new Sommet(0.000000 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				1.000000 * rayon + centreBas.getZ()));
		add(new Sommet(-0.309016 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.951056 * rayon + centreBas.getZ()));
		add(new Sommet(-0.587786 * rayon + centreBas.getX(), 0.00000 + centreBas.getY(),
				0.809016 * rayon + centreBas.getZ()));
		...
		add(new Sommet(1.000000 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				0.000000 * rayon + centreBas.getZ()));
		add(new Sommet(0.951056 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				0.309016 * rayon + centreBas.getZ()));
		add(new Sommet(0.809016 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				0.587786 * rayon + centreBas.getZ()));
		add(new Sommet(0.587786 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				0.809016 * rayon + centreBas.getZ()));
		add(new Sommet(0.309016 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				0.951056 * rayon + centreBas.getZ()));

		add(new Sommet(0.000000 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				1.000000 * rayon + centreBas.getZ()));
		add(new Sommet(-0.309016 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
				0.951056 * rayon + centreBas.getZ()));
		add(new Sommet(-0.587786 * rayon + centreBas.getX(), 0.00000 + centreBas.getY() + hauteur,
