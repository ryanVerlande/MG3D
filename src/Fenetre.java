...
class Fenetre extends JFrame {
    ...
    /**
     * Crée une fenêtre plein écran possédant un titre.
     * <br /><br />
     * @param ttitre Titre de la Fenetre.
     */
	public Fenetre(String ttitre) {
    //Non instanciation du clavier et de la souris
    c=null;
    s=null;
    ...
    // cale la dimension de la fenêtre à la résolution de l'écran
    d = new Dimension (device.getDisplayMode().getWidth(), device.getDisplayMode().getHeight() );
    p = new Panneau ();
