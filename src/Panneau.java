...
/**
 * Cette classe créée une zone d'affichage qui sera incorporée dans un objet de type Fenetre. Cette classe ne devrait, à priori, jamais être instanciée directement par un développeur. Cette classe intégre une liste de formes (Maillage).<br />
 * L'utilisateur peut ajouter ou supprimer un Maillage et effacer un Panneau en passant par la classe Fenetre. Il n'a donc pas à appliquer des méthodes sur des objets de type Panneau. Pour chaque méthode de cette classe, il existe une émthode dans la classe Fenetre qui y fait référence.
...
public class Panneau extends JPanel {
     ...
     * @see Maillage
     */
    public Panneau ( ArrayList < Maillage > a ) {
	super();
	this.a = new ArrayList<Maillage>(a);
    }
     ...
     * @return a ArrayList de Maillage.
     * @see Fenetre#rafraichir Fenetre.rafraichir()
     * @see Maillage
     */
    public ArrayList < Maillage > getA () {
		
	return new ArrayList<Maillage>(a);
    }
     ...
     * @see Point
     */
    public Sommet getMilieu () {

	return new Sommet ( this.getWidth() / 2, this.getHeight() / 2 );
    }
     ...
     * @see Maillage
     */
    public void setA ( ArrayList < Maillage > a ) {
     ...
     * @see Maillage
     */
    public void ajouter ( Maillage d ) {
     ...
     * @see Maillage
     */
    public void supprimer ( Maillage d ) {
